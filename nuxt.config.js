	...
	head: {
		...
		meta: [
			...
			{name: 'viewport', content: 'width=device-width, initial-scale=1'},
			{
				name: 'description',
				hid: 'description',
				content: 'Sig Beginners CTF 2023 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'apple-mobile-web-app-title', content: 'Sig Beginners CTF 2023'},
			{name: 'og:title', content: 'Sig Beginners CTF 2023'},
			{name: 'og:site_name', content: 'Sig Beginners CTF 2023'},
			{name: 'og:description', content: 'Sig Beginners CTF 2023 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo'},
			...
			{name: 'twitter:title', content: 'Sig Beginners CTF 2023'},
			{
				name: 'twitter:description',
				content: 'Sig Beginners CTF 2023 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'twitter:image', content: `${staticBase}/ogimage.jpg`},
			{name: 'twitter:image:alt', content: 'Sig Beginners CTF 2023'},
		],
