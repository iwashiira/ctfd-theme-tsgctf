<template>
	<section class="Index">
		<div class="index-content">
			<h1 class="ctf-logo">Sig XXX Pwn XXX</h1>
...
const contestStart = new Date('2024-04-29T20:00:00+0900').getTime();
const contestEnd = new Date('2025-04-28T20:00:00+0900').getTime();
